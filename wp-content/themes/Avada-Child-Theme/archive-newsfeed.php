<?php
// Template Name: News_archive
get_header(); ?>

<!-- header start -->
	<div class='bg-cont-border col-xs-12 col-sm-12 col-md-12 col-lg-12 firstnlast'>
		...
		<h1 class="nodisplay">Stiri interesante!</h1>
			...
			?>
			<div class="post clearfix col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div class='newsfeed-img blog-img arch-news-img'>
					<div class='newsfeed-img-sec'>
						<a href='<?php the_permalink(); ?>'><?php the_post_thumbnail('world-news-thumb-header'); ?></a>
					</div>
